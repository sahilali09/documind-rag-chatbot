...
This project is a learning-oriented, production-minded reference implementation rather than a complete production deployment.
...
- Comprehensive automated RAG evaluation
- Production observability and tracing
- Horizontal or distributed vector-store scaling

These capabilities can be considered future extensions.